...
##[ KONFIGURASI URL ]##
my $fx29id  = "http://www.onefm.fr/id.txt?"; #Fx29ID (Simple) / (Advanced)
my $fx29id2 = "http://www.onefm.fr/id2.txt?"; #Fx29ID (Advanced)
my $fx29sh  = "http://www.onefm.fr/404.txt?"; #Fx29Sh (Optional)
my $bypass  = "http://corn.bravehost.com/bypas.php?"; #Google Bypasserz (Optional)
